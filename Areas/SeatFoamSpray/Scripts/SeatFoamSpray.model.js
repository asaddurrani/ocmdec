define(["ko", "underscore", "underscore-ko"], function (ko) {
    ...
    SeatFoamSpray = function (specifiedPowerStereringOilId, specifiedPowerSterringOilName, specifiedPowerSterringOilCompany, specifiedPowerSterringOilPrice) {
    ...
    // Brake Oil Factory
    SeatFoamSpray.Create = function (source) {
        return new SeatFoamSpray(source.PowerStereringOilId, source.PowerSterringOilName, source.PowerSterringOilCompany, source.PowerSterringOilPrice);
    };
    //#endregion

    return {
        SeatFoamSpray: SeatFoamSpray,
    };
});
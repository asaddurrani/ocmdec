define(["ko", "underscore", "underscore-ko"], function (ko) {
    ...
    EngineSpray = function (specifiedPowerStereringOilId, specifiedPowerSterringOilName, specifiedPowerSterringOilCompany, specifiedPowerSterringOilPrice) {
    ...
    // Brake Oil Factory
    EngineSpray.Create = function (source) {
        return new EngineSpray(source.PowerStereringOilId, source.PowerSterringOilName, source.PowerSterringOilCompany, source.PowerSterringOilPrice);
    };
    //#endregion

    return {
        EngineSpray: EngineSpray,
    };
});